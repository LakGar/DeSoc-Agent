...
export function Footer() {
  ...
  return (
    <footer className="bg-black/10 backdrop-blur-md border-t border-white/10 text-white pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link href="/" className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">DeSoc Agent</span>
            </Link>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} DeSoc Agent. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <div className="inline-flex items-center bg-white/5 rounded-full px-3 py-1 text-xs font-medium text-gray-300">
